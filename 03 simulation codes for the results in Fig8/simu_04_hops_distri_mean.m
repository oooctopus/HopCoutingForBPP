...
function [hops_distri_simu_mean,X,Y,node_h_cell]=simu_04_hops_distri_mean(R,N,r,loop,v0)
...
%     [shortestDist,connect] = simu_03_netTop_toGraph(X,Y,r); 
    [connect,hops_distri_simu_v0,X,Y,node_h_cell ]= simu_03_hops_distri_once_v0_given(R,N,r,v0  );
